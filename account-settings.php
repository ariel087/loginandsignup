...
if ($_SESSION['status'] == 'invalid' || empty($_SESSION['status'])) {
    ...
    if(isset($_POST['submit'])){
       ...
       $year = mysqli_real_escape_string($connection,$_POST['year']);
        ...
        $queryupdate = "UPDATE account SET studID='{$studID}', firstname='{$firstname}', lastname ='{$lastname}', section ='$section', birthday ='$birthday', age ='{$age}', gender ='{$gender}' WHERE username='{$username}'";
        $sqlUpdate = mysqli_query($connection, $queryupdate); 
        echo '<script>alert("Update successful!")</script>';
        echo ' <script>window.location.href="http://localhost/loginandsignup/home.php"</script>';
    }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="account-settingsstyles.css">
...
<body>
    <div class="main">
        ...
        <div class="inputs" >
        <input type="text" class="studID" name="studID" placeholder="Student ID"required >
        </div>
        <div class="inputs">
        ...
        <div class="inputs" >
        <input type="number" name="age" class="age" placeholder="Age" required>
        </div>
        <div class="inputs">
        <h3>SECTION</h3>
